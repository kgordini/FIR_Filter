...
- **Pipelining Performance:** The [FIR_pipeline](verilog/FIR_pipeline.sv) architecture had the highest Fmax (98.35 MHz), showing how intermediate registers reduce critical path.
- **Parallelism Trade-offs:** [FIR_parallel_L3](verilog/FIR_parallel_L3.sv) increased throughput and increased logic utilization to 34% (38,438 ALMs) comapred to the baseline (12%).
